...
if exist "2026\x86\*.msi" set "_d=%_d% 2026\x86\"
if exist "2026\arm64\*.msi" set "_d=%_d% 2026\arm64\"
...
set /a rnd=%random%
if exist VisualCppRedist_AIO-arm64.exe ren VisualCppRedist_AIO-arm64.exe zVisualCppRedist_AIO-arm64_%rnd%.exe
attrib -A .\* /S /D
7z.exe a VisualCppRedist_AIO-arm64.7z ^
-mqs -mx -m0=BCJ2 -m1=LZMA:d26 -m2=LZMA:d19 -m3=LZMA:d19 -mb0:1 -mb0s1:2 -mb0s2:3 -bso0 ^
%_d%
copy /b 7zSfxMod.sfx + 7zSfxConfigArm64.txt + VisualCppRedist_AIO-arm64.7z VisualCppRedist_AIO-arm64.exe && (
attrib -A .\VisualCppRedist_AIO-arm64.exe
del /f /q VisualCppRedist_AIO-arm64.7z
)
pause
exit /b
